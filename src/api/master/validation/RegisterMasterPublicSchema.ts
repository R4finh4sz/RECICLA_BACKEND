...
} from "../services/helpers/password-policy";
...
export const RegisterMasterPublicSchema = z
  .object({
    nome: z
      .string()
...
export type RegisterMasterPublicInput = z.infer<
  typeof RegisterMasterPublicSchema
>;
